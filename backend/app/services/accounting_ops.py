...
#
# **این با «انتقال حساب به سرفصل دیگر» (پایین‌تر) یکی نیست و نباید یکی شود.**
#
...
def issue_reclass(
    ...
    entry = make_journal_entry(
        db,
        as_of,
        description.strip() or f"انتقال مانده به حساب دیگر تا {as_of}",
        "reclassification",
        user,
        lines,
    )
...
# حسابِ درست، بخشِ ۸ بالا («انتقال مانده به حساب دیگر») درست است.
