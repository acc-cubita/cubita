...
سندِ **تسعیرِ ارز** و **اختتامیه/افتتاحیه** هم با همین استدلال مسدود نمی‌شوند:
ردیف‌هایشان ابعادشان را از *مانده‌ای* که می‌بندند یا تسعیر می‌کنند کپی می‌کنند، نه
از انتخابِ کاربر. بدونِ این، مانده‌ای که
