...
const STEPS = [
  ...
  {
    icon: Settings2,
    title: 'کسب‌وکار شما همان لحظه ساخته می‌شود',
    desc: 'بلافاصله بعد از تأیید پرداخت، نسخه‌ی اختصاصی و ایزوله‌ی شما ساخته می‌شود و لینک تعیین رمز عبور به ایمیلتان می‌رسد.',
  },
  {
    icon: Rocket,
    title: 'شروع به کار',
    desc: 'رمز عبورتان را تعیین کنید، وارد اپ دسکتاپ یا نسخه‌ی وب شوید و اولین فاکتور را ثبت کنید.',
  },
]
    ...
    <section id="how-it-works">
      <div className="container">
        <div className="section-head">
          ...
          <p>از انتخاب پلن تا ثبت اولین فاکتور، چند دقیقه بیشتر طول نمی‌کشد.</p>
        </div>
