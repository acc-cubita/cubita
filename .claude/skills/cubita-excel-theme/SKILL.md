...
| مالیات بر ارزش افزوده | این PR | د: برگه‌ی اظهارنامه (بخش + برگشتِ منفی + جمعِ بخش، خالص در پانویس با نشانِ پرداختنی/استردادی)؛ «همه‌ی گزارش‌ها» هم فهرستِ اکسلی شد | [VatPage.tsx](../../../desktop/src/pages/accounting/VatPage.tsx) |
