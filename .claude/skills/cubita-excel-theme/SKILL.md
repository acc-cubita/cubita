...
| گزارش دفتر | این PR | د: روزنامه با سرگروهِ سند و ردیف‌هایش در یک گرید؛ کل/معین/تفصیلی گریدِ گردش با مانده‌ی اول، جمع و انتخاب؛ پارامترِ هر دفتر در سطرِ اولِ سربرگ | [LedgerReportPage.tsx](../../../desktop/src/pages/accounting/LedgerReportPage.tsx) |
