...
| بررسی یکپارچگی | #225 | د: یک گرید برای نُه بررسی — سرگروهِ بازوبسته با چیپِ وضعیت و یافته‌ها زیرش، یافته‌ها اول (خطا، هشدار، سالم)، «جمعِ دفتر» با نتیجه‌ی کل در پانویس، مقصدِ یافته سند/کاردکس/دفتر | [IntegrityPage.tsx](../../../desktop/src/pages/accounting/IntegrityPage.tsx) |
