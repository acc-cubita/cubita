...
| دفاتر تجارت الکترونیک | (این PR) | د: گریدِ دفترِ حساب (`lr-ledger`) بی مانده — شماره‌ی ردیفِ پیوسته، شماره و تاریخِ سند فقط روی ردیفِ اولِ هر سند، دامنه‌ی «همه/دائم/موقت» که دفترِ جدا می‌سازد، ساختنِ ۵۰۰تایی با چاپ و CSVِ کلِ دفتر | [LegalBooksPage.tsx](../../../desktop/src/pages/accounting/LegalBooksPage.tsx) |
