...
| گزارش ترازها | این PR | د: سرستونِ دوطبقه (گروه بالای جفتِ بدهکار/بستانکار)، «جمع» با نشانِ توازن در `tfoot`، ستون‌های حسابِ میخ‌شده سمتِ راست، سطرِ «قالب» در سربرگ | [BalanceReportPage.tsx](../../../desktop/src/pages/accounting/BalanceReportPage.tsx) |
