...
| درختواره حساب‌ها | این PR | ب روی درخت: ویرایشِ درجای کد/نام/عنوانِ دوم/ماهیت/وضعیت، «+» زیرِ هر سرفصل با کدِ پیشنهادی، ذخیره‌ی پشتِ‌سرِ‌هم (کد با مسیرِ جدا)، ویژگی‌ها در ستونِ خودشان | [ChartOfAccountsPage.tsx](../../../desktop/src/pages/accounting/ChartOfAccountsPage.tsx) |
