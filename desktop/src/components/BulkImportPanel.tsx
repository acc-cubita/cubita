 ...
 * کالا به انبار تعلق دارد و فهرستِ اشخاص به طرف‌حساب‌ها. پس پنل مشترک است: کالا تبِ
 * صفحه‌ی «انبار» است و اشخاص صفحه‌ی «ورود گروهی اشخاص» در «تنظیمات» (به خواستِ کاربر،
 * کنارِ بقیه‌ی کارهای راه‌اندازی). مجوزِ سمتِ سرور هم همین را می‌گوید:
