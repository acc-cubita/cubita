...
describe('گریدِ ۳۰۰ ردیفی — رندر', () => {
  it('سوارشدن، تایپ در ردیفِ ۱۵۰، و Enter', () => {
    ...
    //: سقفِ زمانِ خودِ تست، نه آستانه‌ی کارایی: سه بار سوارکردنِ ۳۰۰ ردیف به‌تنهایی
    //: ۲ تا ۴ ثانیه است و کنارِ بقیه‌ی فایل‌های موازی از ۵ ثانیه‌ی پیش‌فرض می‌گذشت —
    //: یک‌بار در اجرای کامل همین شد. رانرِ CI از این دستگاه کندتر است.
  }, 60_000)
})
