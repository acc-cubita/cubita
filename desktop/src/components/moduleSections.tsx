...
export const MODULE_SECTIONS: Partial<Record<PageKey, SectionDef[]>> = {
  ...
  inventory: [
    ...
    { key: 'stock', label: 'موجودی', icon: PackageSearch, kind: 'list' },
    { key: 'kardex', label: 'کاردکس', icon: History, kind: 'list' },
    { key: 'low', label: 'نیازمندِ سفارش', icon: AlertTriangle, kind: 'list' },
