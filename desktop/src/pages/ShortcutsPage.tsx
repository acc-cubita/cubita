...
function BuiltInShortcutsCard() {
  const rows: Array<[string, string, string]> = [
    ...
    ['Enter', 'مقدارِ بعدی؛ در ستونِ مبلغِ خالی، پذیرشِ باقی‌ماندهٔ توازن و رفتن به خانه‌ی بعد', 'گریدِ سند — حالت حسابدار'],
    ...
    ['Ctrl + /', 'باز و بسته کردنِ راهنمای میان‌برهای زیرِ گرید', 'سندِ حسابداری — حالت حسابدار'],
    ['Ctrl + G', 'رفتن به ردیف (شماره را بنویسید و Enter)', 'گریدِ سند — حالت حسابدار'],
