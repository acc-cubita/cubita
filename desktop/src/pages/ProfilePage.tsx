  ...
  return (
    ...
    >
      ...
      <p className="muted exp-note">
        «حالت حسابدار» ثبتِ سند را به گریدِ فشرده‌ی صفحه‌کلیدمحور تبدیل می‌کند، فاکتورها و
        فرم‌های انبار را به‌جای مرحله‌به‌مرحله یک‌جا و فشرده نشان می‌دهد، «حسابداری» و «دریافت
        و پرداخت» را در منو جلو می‌آورد و کارت‌های پیش‌فرضِ داشبورد را کارت‌های حسابداری
        می‌کند. تمِ رنگی جداست و در «تنظیمات ← ظاهر» انتخاب می‌شود.
      </p>
    </SectionCard>
  )
}
