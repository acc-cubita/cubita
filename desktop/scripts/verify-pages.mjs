...
const TARGETS = [
  ...
  //: تبِ «فاکتور خرید خدمات» — فرمِ خدمت با کسورات و دفترِ همان فاکتورها.
  ['تامین‌کنندگان و انبار', 'فاکتور خرید خدمات'],
  ['تامین‌کنندگان و انبار', 'انواع کسورات'],
  //: فصلِ «اعلامیه بدهکار و بستانکار» — فرمِ دوسمتی با پنلِ اطلاعات حساب، از هر
  //: دو گروه (همان صفحه)، و دفترش با ردیف‌های بازشونده.
  ['تامین‌کنندگان و انبار', 'اعلامیه بدهکار بستانکار'],
  ['مشتریان و فروش', 'اعلامیه بدهکار بستانکار'],
  ['مشتریان و فروش', 'اعلامیه‌های بدهکار و بستانکار'],
