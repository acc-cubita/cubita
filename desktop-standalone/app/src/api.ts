// محصولِ محلی: آدرسِ پایه از preload می‌آید (پورتِ پویای سایدکاری که main اسپاون کرد).
// در اجرای وبِ صرف (بدونِ Electron، مثلِ dev در مرورگر) این bridge نیست و به VITE_API_URL
// یا حدسِ پیش‌فرضِ محلی برمی‌گردد.
const API_BASE_URL =
  window.hesabdariEnv?.apiBaseUrl ?? import.meta.env.VITE_API_URL ?? 'http://127.0.0.1:8799'
