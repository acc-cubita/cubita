...
import { ShoppingCart, FileText, Undo2, Landmark, TrendingUp, CalendarRange, Receipt, Coins } from 'lucide-react'
  ...
  return (
    <div className="page">
      <PageHeader
        icon={ShoppingCart}
        title="فروش"
        description="برای هر فروش یک فاکتور بزنید — موجودی انبار و سند حسابداری آن به‌طور خودکار ثبت می‌شود."
      />
