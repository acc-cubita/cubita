...
class Settings(BaseSettings):
    ...
    # نسخه‌ی محلیِ دسکتاپ: پیش‌فرض SQLite محلی. Electron هنگام اجرا مسیرِ فایلِ دیتابیس را
    # در پوشه‌ی دیتای کاربر با DATABASE_URL بازنویسی می‌کند. (Postgres همچنان پشتیبانی می‌شود.)
    database_url: str = "sqlite:///./hesabdari-local.db"
