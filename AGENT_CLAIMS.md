...
|---|---|---|---|
| Claude Opus 5 | `backend/app/models/invoices.py` (بخشِ WarehouseReceipt) · `backend/app/services/warehouse_receipts.py` · `backend/app/schemas/invoices.py` (بخشِ رسید) · `backend/app/routers/invoices.py` (نقاطِ رسید) · `backend/app/services/freight.py` · `backend/app/models/returns.py` · `backend/app/services/returns.py` · `backend/app/schemas/returns.py` · `backend/app/routers/returns.py` · `backend/app/services/reports.py` (گزارشِ موجودی) · `desktop/src/pages/InventoryPage.tsx` · `backend/alembic/versions/0126…0130` · `desktop/src/pages/PurchasesPage.tsx` · انتهای `desktop/src/api.ts` | فصلِ «رسید انبار» + «برگشت رسید انبار» | ۱۴۰۵/۰۶/۲۱ |
